...
type LegacyOutboundSendResult = { messageId: string } & Record<string, unknown>;

type LegacyOutboundSendFn = (
  to: string,
  text: string,
  opts?: Record<string, unknown>,
) => Promise<LegacyOutboundSendResult>;

export type OutboundSendDeps = {
  sendWhatsApp?: LegacyOutboundSendFn;
  sendTelegram?: LegacyOutboundSendFn;
  sendDiscord?: LegacyOutboundSendFn;
  sendSlack?: typeof sendMessageSlack;
  sendSignal?: LegacyOutboundSendFn;
  sendIMessage?: LegacyOutboundSendFn;
